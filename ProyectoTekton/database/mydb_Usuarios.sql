...
CREATE TABLE `Usuarios` (
  ...
  `Tipo` bit(1) NOT NULL,
  `descripcion_usuario` varchar(500) NOT NULL,
  `img_perfil` varchar(150) NOT NULL,
  ...
  PRIMARY KEY (`idUsuarios`,`id_ubicacion`),
  KEY `id_ubicacion_idx` (`id_ubicacion`),
  CONSTRAINT `id_ubicacion` FOREIGN KEY (`id_ubicacion`) REFERENCES `Ubicación` (`idUbicación`)
